...
@Client.on_message(filters.private & filters.command(["font"]) & filters.user(ADMINS + ([OWNER_ID] if OWNER_ID else [])))
async def style_buttons(c, m, cb=False):
    buttons = [[
        ...
        InlineKeyboardButton('𝓼𝓬𝓻JMenuItem', callback_data='style+script_bolt'),
        InlineKeyboardButton('ᵗⁱⁿʸ', callback_data='style+tiny'),
        ],[
        InlineKeyboardButton('ᑕOᗰIᑕ', callback_data='style+comic'),
        InlineKeyboardButton('𝗦𝗮𝗻𝘀', callback_data='style+sans'),
        InlineKeyboardButton('𝙎𝙖𝙣s', callback_data='style+slant_sans'),
        ],[
