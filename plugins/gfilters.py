...
@Client.on_message(filters.command(['gfilter', 'addg']) & filters.incoming & filters.user(ADMINS + ([OWNER_ID] if OWNER_ID else [])))
...
@Client.on_message(filters.command(['viewgfilters', 'gfilters']) & filters.incoming & filters.user(ADMINS + ([OWNER_ID] if OWNER_ID else [])))
...
@Client.on_message(filters.command('delg') & filters.incoming & filters.user(ADMINS + ([OWNER_ID] if OWNER_ID else [])))
...
@Client.on_message(filters.command('delallg') & filters.user([OWNER_ID] if OWNER_ID else ADMINS))
