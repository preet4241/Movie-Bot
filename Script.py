...
<blockquote>Developed By <a href="https://t.me/PR_GAMING_25">ＰＲΞΞＴ𓆩Ｂₒ₱₵ₕɆ𓆪 </a></blockquote>
</b>"""

    # Owner Panel Message
    OWNER_PANEL_TXT = """<b>
🌟 Wᴇʟᴄᴏᴍᴇ Oᴡɴᴇʀ {},<br>
Yᴏᴜ ʜᴀᴠᴇ ꜰᴜʟʟ ᴄᴏɴᴛʀᴏʟ ᴏᴠᴇʀ <a href="https://t.me/{}">{}</a>.<br>
Mᴀɴᴀɢᴇ ᴀʟʟ ʙᴏᴛ ꜰᴇᴀᴛᴜʀᴇꜱ ᴀɴᴅ sᴇᴛᴛɪɴɢs ꜰʀᴏᴍ ᴛʜɪs ᴘᴀɴᴇʟ! 👑<br>
<blockquote>Oᴡɴᴇʀ Aᴄᴄᴇss Gʀᴀɴᴛᴇᴅ ✓</blockquote>
</b>"""

    # Admin Panel Message  
    ADMIN_PANEL_TXT = """<b>
🔧 Wᴇʟᴄᴏᴍᴇ Aᴅᴍɪɴ {},<br>
Yᴏᴜ ʜᴀᴠᴇ ᴀᴅᴍɪɴɪsᴛʀᴀᴛɪᴠᴇ ᴀᴄᴄᴇss ᴛᴏ <a href="https://t.me/{}">{}</a>.<br>
Mᴀɴᴀɢᴇ ᴜsᴇʀs, ʙʀᴏᴀᴅᴄᴀsᴛs ᴀɴᴅ ʙᴀsɪᴄ sᴇᴛᴛɪɴɢs ꜰʀᴏᴍ ʏᴏᴜʀ ᴀᴅᴍɪɴ ᴘᴀɴᴇʟ! ⚡<br>
<blockquote>Aᴅᴍɪɴ Aᴄᴄᴇss Aᴄᴛɪᴠᴇ ✓</blockquote>
</b>"""

    # User Panel Message
    USER_PANEL_TXT = """<b>
👋 Hᴇʏ {},<br>
Wᴇʟᴄᴏᴍᴇ ᴛᴏ <a href="https://t.me/{}">{}</a>!<br>
Eɴᴊᴏʏ ᴍᴏᴠɪᴇs ᴀɴᴅ sᴇʀɪᴇs – ᴄʜᴇᴄᴋ ᴏᴜᴛ ᴏᴜʀ ɢʀᴏᴜᴘs ᴀɴᴅ ɢᴇᴛ ʏᴏᴜʀ ꜰᴀᴠᴏʀɪᴛᴇ ᴄᴏɴᴛᴇɴᴛ! 🎬<br>
<blockquote>Eɴᴊᴏʏ Yᴏᴜʀ Mᴏᴠɪᴇ Exᴘᴇʀɪᴇɴᴄᴇ! 🍿</blockquote>
</b>"""
